...
https://docs.docker.com/engine/install/ubuntu/#install-using-the-repository[installing docker]
...
https://docs.docker.com/compose/install/#install-compose[installing docker-compose]
...
[source, bash]
----
docker-compose -f docker-compose.yml -f docker-compose.arm.yml -f docker-compose.prod.yml up --build --force-recreate -d
----
