...
Now you can enter the dashboard via the URL ``http://192.168.178.7:8001/api/v1/namespaces/kubernetes-dashboard/services/http:kubernetes-dashboard:/proxy``
...
.start minikube on Raspberry Pi with local ip
[source, bash]
----
